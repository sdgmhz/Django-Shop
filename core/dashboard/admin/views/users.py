...
class UserListView(LoginRequiredMixin,HasAdminAccessPermission, ListView):
    ...
    def get_queryset(self):
        queryset = User.objects.filter(is_superuser=False,type=CustomUserType.customer.value).order_by("-created_date")
...
class UserDeleteView(LoginRequiredMixin,HasAdminAccessPermission,SuccessMessageMixin, DeleteView):
    ...
    def get_queryset(self):
        return User.objects.filter(is_superuser=False,type=CustomUserType.customer.value)
